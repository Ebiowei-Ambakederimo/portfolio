...
const Works = () => {
  ...
  return (
    <section id="work" className="flex bg-white flex-col min-h-screen">
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex justify-between px-10 text-black transition-all duration-500 md:group-hover:px-12 md:group-hover:text-white">
              ...
              {/* <p className="lg:text-[32px] text-[26px] leading-none">{project.description}</p> */}
              <Icon icon="lucide:arrow-up-right" className="md:size-6 size-5" />
            </div>
            </Link>

            {/* divider */}
            <div className="relative z-10 w-full h-0.5 bg-black/80" />
        ...
        <div
          ref={previewRef}
          className="fixed top-0 left-0 z-[9999] overflow-hidden w-[400px] h-[300px] pointer-events-none opacity-0 scale-95 hidden md:block border-4 border-black"
        >
          {currentIndex !== null && (
            <Image
